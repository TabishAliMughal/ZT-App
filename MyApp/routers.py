class AppRouter:
    route_app_labels = {'admin','auth','Authentication','Main','User','social_django','contenttypes','sessions','messages','staticfiles','storages','background_task','user_visit','Points'}
